...
@section('title', '地方創生ゲーム お問い合わせ - 株式会社エヴォルブド・インフォ')
    ...
    <section class="contactWrapper">
        <div class="container">
            <div class="col-xs-12 evo_input" @if(session('success')) style="display:none;" @endif>
                ...
                <form action="{{ route('contact.game.submit') }}" method="post" class="form-horizontal" novalidate>
                    @csrf
