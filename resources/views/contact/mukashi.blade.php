...
@section('title', '昔ばなし絵巻 お問い合わせ - 株式会社エヴォルブド・インフォ')
        ...
        <nav id="bc">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">昔ばなし絵巻 お問い合わせ</li>
                </ol>
            </div>
        </nav>
    </nav>
    ...
    <section class="contactWrapper">
        <div class="container">
            <div class="col-xs-12 evo_input" @if(session('success')) style="display:none;" @endif>
                ...
                <form action="{{ route('contact.mukashi.submit') }}" method="post" class="form-horizontal" novalidate>
                    @csrf
