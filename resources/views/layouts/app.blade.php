...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/logo_evo2.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/img/logo_evo2.png') }}">
    <link rel="shortcut icon" href="{{ asset('assets/img/logo_evo2.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('assets/img/logo_evo2.png') }}">
